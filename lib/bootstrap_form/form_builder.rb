module BootstrapForm
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    %w{email_field search_text_field text_field text_area password_field collection_select file_field date_select select}.each do |method_name|
        ...
        content_tag :div, class: "control-group#{(' error' if object.errors[name].any?)}"  do
          ...
          content_tag(:div, class: 'controls') do
            ...
            if method_name == 'email_field'
              ...
              content_tag(:div, super(name, *args) + content_tag(:button, content_tag(:i, nil, class:'icon-inverse icon-white', id:'search_append_button'), class: 'btn btn-warning'), class: 'input-append') + help
